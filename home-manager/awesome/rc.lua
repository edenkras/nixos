...
awful.keyboard.append_global_keybindings({
    awful.key({ modkey }, "w", function()
        awful.util.spawn("rofi -show window -theme-str 'element-icon { size: 3ch; margin: 0.5ch }'")
    end,
            { description = "rofi window", group = "rofi" }),
    awful.key({ modkey }, "r", function()
        awful.util.spawn("rofi -show drun -theme-str 'element-icon { size: 3ch; margin: 0.5ch }'")
    end,
